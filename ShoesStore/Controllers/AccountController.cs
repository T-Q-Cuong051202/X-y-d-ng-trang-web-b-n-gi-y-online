...
namespace ShoesStore.Controllers
{
    public class AccountController : Controller
    {
        ...
        public IActionResult Register(RegisterViewModel model)
        {
            ...
            // Thêm đoạn này: tự động đăng nhập sau khi đăng ký thành công
            HttpContext.Session.SetString("Email", newTk.Email);
            HttpContext.Session.SetString("Loaitk", newTk.Loaitk.ToString());
